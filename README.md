...
This proposed method is able to convert a unit vector, usually composed of 3 floating point numbers (x,y,z) for a total size of 4x3x8=96bit, into a 16-bit number.
A unit vector ,
